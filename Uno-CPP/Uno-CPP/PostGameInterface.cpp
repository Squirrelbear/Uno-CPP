...
void PostGameInterface::initialiseInterface(const sf::Font & font, RuleSet * ruleSet)
{
	...
	unoShadow->setOffset(sf::Vector2f(_bounds.width / 2 - 40, 50 - 40));
	...
	uLetter->setOffset(sf::Vector2f(_bounds.width / 2 - 40 + 2, 48 - 40));
	...
	nLetter->setOffset(sf::Vector2f(_bounds.width / 2 - 40 + 2 + 30, 48 - 40));
	...
	oLetter->setOffset(sf::Vector2f(_bounds.width / 2 - 40 + 2 + 60, 48 - 40));
	...
	exclamationMark->setOffset(sf::Vector2f(_bounds.width / 2 - 40 + 2 + 90, 48 - 40));
	...
	roundScoreTitle->setOffset(sf::Vector2f(_bounds.width / 2 - 10, 180));
	...
	totalScoreTitle->setOffset(sf::Vector2f(_bounds.width / 2 - 170, 180));
	...
	for (int i = 0; i < _playerList.size(); i++) {
		...
		playerStringText->setOffset(sf::Vector2f(_bounds.width / 4 + 50, 240 + i * 60));
		...
		currentRoundScore->setOffset(sf::Vector2f(_bounds.width / 2, 240 + i * 60));
		...
		totalScore->setOffset(sf::Vector2f(_bounds.width / 2 + 180, 240 + i * 60));
	...
	DrawableLine* line5 = new DrawableLine({ sf::Vector2f(_bounds.width / 2 - 40, 150), sf::Vector2f(_bounds.width * 3 / 4 - 10, 200 + _playerList.size() * 60) });
	_staticElements->addChild(line4);
	...
	winnerTitle->setOffset(sf::Vector2f(_bounds.width / 4 + 25, 490));
	...
	winnerLabel->setOffset(sf::Vector2f(_bounds.width / 4 + 175, 490));
	...
	scoreLimitText->setOffset(sf::Vector2f(_bounds.width / 2 + 20, 490));
	...
	if (scoreLimitReached) {
		...
		scoreLimitReachedText->setOffset(sf::Vector2f(_bounds.width / 2 + 40, 530));
		...
		_buttonList.emplace_back(Button(sf::IntRect(_bounds.width / 2 + 125 + 20, 620, 250, 40), "New Game Same Settings", 3, font));
	}
	else {
		_buttonList.emplace_back(Button(sf::IntRect(_bounds.width / 2 - 250 - 10, 620, 250, 40), "Return to Lobby", 1, font));
		_buttonList.emplace_back(Button(sf::IntRect(_bounds.width / 2 + 10, 620, 250, 40), "New Game Same Settings", 3, font));
	}
